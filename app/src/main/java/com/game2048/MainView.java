...
public class MainView extends View {
    ...
    private final Drawable newGameIcon;
    private final Drawable undoIcon;
    private final Drawable cheatIcon;
    private final Drawable settingIcon;
    private final Drawable AIIcon;
    ...
    public MainView(Context context, boolean isNightMode) {
        ...
        Drawable fadeRectangle = resources.getDrawable(R.drawable.fade_rectangle);
        ...
        this.setBackgroundColor(isNightMode ? resources.getColor(R.color.background_night) : resources.getColor(R.color.background));
